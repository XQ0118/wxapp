...
Page({
  data: {
    ...
    tomorrow: {},
    afterTomor: {},
    todyIcon: '../../content/images/cond/999.png',
    tomorrowIcon: '../../content/images/cond/999.png',
    afterTomorIcon: '../../content/images/cond/999.png'
  },
  onShow: function () {
    this.getLocation();
  },
  ...
  getWeatherInfo: function (latitude, longitude) {
    var _this = this;
    var key = 'e0a5018f92c4457fac512d3e5f92d5d8';//你自己的key
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        _this.setData({
          ...
          todyIcon: '../../content/images/cond/' + daily_forecast_today.cond_code_d + '.png', //在和风天气中下载天气的icon图标，根据cond_code_d显示相应的图标
          tomorrowIcon: '../../content/images/cond/' + daily_forecast_tomorrow.cond_code_d + '.png',
          afterTomorIcon: '../../content/images/cond/' + daily_forecast_afterTomor.cond_code_d + '.png'
        });
      }
    })
  }
